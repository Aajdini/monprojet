...
public class FrmNouveau extends java.awt.Frame { 
    ...
    private ArrayList listeDepartements;
  ...
  public FrmNouveau () {
    initComponents();
    listeDepartements = DepartementDao.getDepartements();
    listeFonctions = FonctionDao.getFonctions();
    chargerChoice(listeDepartements,chDepartements);
    chargerChoice(listeFonctions,chFonctions);
  ...
  private void chargerChoice(ArrayList liste, Choice ch){
      for(int i = 0 ; i <liste.size(); i ++){
          ch.add(liste.get(i).toString());
      }
  }//chargerChoice
   ...
   */
    ...
    private void btnEnregistrerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnregistrerActionPerformed
        for(int i = 0; i < listeFonctions.size(); i++){
                Fonction f = (Fonction)listeFonctions.get(i);
        ...
        for(int i = 0; i < listeDepartements.size(); i++){
                Departement d = (Departement)listeDepartements.get(i);
